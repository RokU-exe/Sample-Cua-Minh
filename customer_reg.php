...
<script>
  var loadFile = function(event) {
   ...
   <input type="text" name="customername" required placeholder="Enter your name"><br>
   <label for="customeraddress">Address</label><br>
   <input type="text" name="customeraddress" required placeholder="Enter your address"><br>
