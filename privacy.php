...
1.1. Lazada and its affiliates (collectively or individually, "Lazada", "we" or "us") take your privacy seriously. In Vietnam, the Lazada entity controlling your personal data will be Lazada South East Asia Pte. Ltd. and/or Recess Company Limited.
...
1.4. It is important that you read this Privacy Policy together with any other applicable notices we may provide for special applications where when we are collecting, using, disclosing and/or processing personal data about you, so that you are fully aware of how and why we are using your personal data.
...
1.7. All of these terms apply to Lazada's users, whether or not the users have created an account as Customers and/or Sellers, unless otherwise stated specifically to apply only to Customers or only to Sellers.

2. The personal data we collect from you

2.1. We collect the personal data described below in accordance with applicable local laws and, if required, upon obtaining your consent.

2.2. Personal data means any information about an individual, whether recorded in a material form or not and whether true or not, who can be identified from that data (whether directly or indirectly), or from that data and other data to which we have or are likely to have access.
...
(a) Identity and Profile Data, which may include your name, date of birth, gender, username and password, email address, telephone number, your interests, and any personal data in any photographs or videos or audio recordings that you upload onto our Platform. 

• Where you are a Seller, we may also collect your company name, address, date of incorporation, and other business-related information (e.g. company registration number, business licence, tax information, shareholder and director information).
...
(c) Usage Data, such as information about how and when you use the Platform, products and Services or view any content on the Platform, as well as websites you were visiting before you came to the Platform and other similar statistics.
...
(e) Location data, such as when you check for deals near you or the delivery / pick-up status of orders.

2.4. We automatically collect and process certain types of information when you use your devices to access our Platform and interact with our Services for the purposes set out herein. 
...
3.2. Depending on your relationship with us (for example, whether you are a Customer, a Seller, a visitor to our websites, or a user of our mobile applications), the personal data which we collect from you or via third parties may be used for certain purposes, as follows: 

(a) To facilitate your use of the Services or access to the Platform.

(b) To administer the online account that you may have set up with us.

(c) To conduct analytics, research, business and development: 

• To better understand user experience with the Services and the Platform;
...
• To prevent or investigate any actual or suspected violations of our Terms of Use, Privacy Policy or any of our policies, fraud, unlawful activity, omission or misconduct, whether relating to your use of our Services or any other matter arising from your relationship with us;

• To perform due diligence checks;

• To comply with legal and regulatory requirements (including, where applicable, the display of your name, contact details and company details), including any law enforcement requests, requests by any governmental or regulatory authority having jurisdiction over Lazada, in connection with any legal proceedings, or as otherwise deemed necessary by us; and

• To protect the life, health or personal safety of Lazada’s employees, its users and/or the public.
...
3.3. Where you are a Customer and/or you have signed in or registered with us, the personal data which we collect from you or via third parties may be used for other purposes, as follows:
...
• To provide customer support for your orders, for example, to return products that you have purchased through the Platform; and
...
• To assess your application for loan facilities and/or to perform credit risk assessments in relation to applications for financial services and products, such as credit or loan facilities, insurance or credit cards (where applicable); and
...
• To send you marketing or promotional information about our or third-party sellers’ products and services on our Platform from time to time;

• To help us conduct marketing and advertising; and

• To promote the Services and use the information that you give to us, such as user-generated content (including video content) that you can choose to upload or broadcast on our Platform and will be accessible on the Internet and may be shared by the public (the latter of which is not within our control), as part of our advertising and marketing campaigns to promote the Platform.

(iv) Other

• To know our Customers better; and

• To conduct automated decision-making processes in accordance with any of the above purposes, which will be carried out in compliance with our obligations under applicable laws, including to notify and obtain your consent to the same.

3.4. Where you are a Seller, the personal data which we collect from you or via third parties may be used for other purposes, as follows:

(i) Providing Services

• To ship or deliver the products you have listed or sold through the Platform. We may pass your personal information on to a third party (e.g. our logistics partners, our affiliates) or relevant regulatory authority (e.g. customs) in order to carry out shipping or delivery of the products listed or sold by you;

• To respond to your queries, feedback, claims or disputes, whether directly or through our third party service agents;

• To verify your documentation submitted to us to facilitate your onboarding with us as a Seller on the Platform, including the testing of technologies to enable faster and more efficient onboarding;
...
• To assess your application for loan facilities and/or to perform credit risk assessments in relation to your applications for seller financing and products, including credit or loan facilities, insurance or credit cards (where applicable);
...
• To know our Sellers better; and

• To conduct automated decision-making processes in accordance with any of these purposes, which will be carried out in compliance with our obligations under applicable laws, including to notify and obtain your consent to the same.

Persons or organizations who can approach such information

3.5. We may share (or permit the sharing of) your personal data with and/or transfer your personal data to third parties and/or our affiliates for the above-mentioned purposes. These third parties and affiliates, which may be located inside or outside your jurisdiction, include but are not limited to:
...
4.3. You may unsubscribe from receiving marketing information at any time in our mobile application settings or by using the unsubscribe function within the electronic marketing material. 

5. Method and instrument for users (including consumers) to approach and correct their personal data on the e-commerce system of entity collecting data
...
7. Information retaining period

7.1. We will only retain your personal data for as long as we are either required or permitted to by law or as relevant for the purposes for which it was collected.
...
8.1. Lazada does not sell products to minors (which is to be determined based on the applicable law), nor does it intend to provide any of the Services or the use of the Platform to minors. We do not knowingly collect any personal data relating to minors.

8.2. You hereby confirm and warrant that you are above the age of minority and you are capable of understanding and accepting the terms of this Privacy Policy. If you are a minor, you may use our Platform only with the involvement of a parent or legal guardian.
...
10. Address of entity collecting and managing data, including contact method for users (including consumers) to inquire about the collection, process activities of information related to the consumer

10.1. If you have any questions on personal data protection or data privacy, please refer to our list of frequently asked questions on data protection / privacy.

10.2. If you have other concerns about our data protection / privacy practices, or wish to exercise any rights you may have under applicable law, please feel free to contact us via our online chat service or as follows:

Recess Company Limited

Address: Floor 19, Saigon Centre – Tower 2, Ben Nghe Ward, District 1, Ho Chi Minh City

Email: legal@lazada.vn 

11 Mechanism of receiving and processing complaints of users (including consumers) relating to personal information being used improperly with the announced purpose or scope

11.1 In case you have any suspicions about your personal data being used with improper purpose or scope of use that we announced, you can submit your questions or complaints about our use of your personal data via our online chat service or our contact details specified in Section 10.2.

11.2 Our data protection staff will receive your complaints and subject to the nature and degree of your queries or complaints, we will have detailed measures to resolve your queries or complaints.

This Privacy Policy shall take effect on 6 June 2022.
                </P>
            </main>
        </div>  
        <footer id="footer">
